...
GOOGLE_CLIENT_ID = "293572781175-l3r0d8a1j20g3doc7dqo3f45ltrck1i4.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.w9jrimt.mongodb.net/ResumeRanking'
